...
export const DelegateTaskTool = {
    name: 'delegate_task',
    description: '将复杂任务委派给专门的子Agent执行。系统自动将任务分解为子任务，匹配最合适的Agent（架构师/开发者/测试/审查员/DevOps/文档员），并行或串行执行。' +
 ...
 */
export const InstallRuntimeTool = {
    ...
    async execute(params, context) {
        try {
            ...
            const names = { node: 'Node.js', python: 'Python' };
