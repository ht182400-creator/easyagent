...
export const NpmRunTool: ITool = {
  ...
  async execute(params, context): Promise<ToolResult> {
    try {
      ...
      const cwd = params.cwd ? resolve(context.workspace, params.cwd as string) : context.workspace;
 ...
 */
export const EnvInfoTool: ITool = {
  name: 'env_info',
 ...
 * 快速了解项目目录结构和技术栈
 */
export const ProjectStatsTool: ITool = {
