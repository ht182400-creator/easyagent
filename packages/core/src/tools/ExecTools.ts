 ...
 * Git差异工具
 */
export const GitDiffTool: ITool = {
  name: 'git_diff',
 ...
 * Git分支管理工具
 */
export const GitBranchTool: ITool = {
  name: 'git_branch',
  ...
  async execute(params, context): Promise<ToolResult> {
    try {
      ...
      switch (action) {
        ...
        case 'create': {
          if (!branchName) return { success: false, content: '请指定分支名称' };
 ...
 * Git Blame工具 - 查看代码所属
 */
export const GitBlameTool: ITool = {
  name: 'git_blame',
 ...
 * Git提交工具 - 创建新提交
 */
export const GitCommitTool: ITool = {
  name: 'git_commit',
