...
export type { IMPlatform, IMAdapterStatus, IMAdapterConfig, TelegramConfig, FeishuConfig, WeChatConfig, AnyIMConfig, IMMessage, IMAttachment, IMSendOptions, IMInlineButton, IMAdapterCallbacks, IMSessionMapping, IMAdapterEvent, } from './types.js';
