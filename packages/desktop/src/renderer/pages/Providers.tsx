...
export default function Providers() {
  ...
  const handleSetKey = async (providerId: string) => {
    try {
      await apiFetch(`/api/providers/${providerId}/key`, {
        method: 'PUT',
  ...
  const handleRefreshProvider = async (providerId: string) => {
    ...
    try {
      await apiFetch(`/api/providers/${providerId}/models/refresh`, { method: 'POST' });
  ...
  const handleTest = async (providerId: string) => {
    ...
    try {
      const data = await apiFetch<{ success: boolean; error?: string }>(`/api/providers/${providerId}/test`, { method: 'POST' });
      setTestResults(prev => ({
        ...prev,
