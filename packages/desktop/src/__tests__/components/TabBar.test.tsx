...
describe('TabBar', () => {
  ...
  describe('多个标签', () => {
    beforeEach(() => {
      const tabs = [
        { id: 'tab-1', type: 'chat' as const, title: '对话1', closable: true },
        { id: 'tab-2', type: 'chat' as const, title: '对话2', closable: true },
        { id: 'tab-3', type: 'settings' as const, title: '设置', closable: false },
      ];
