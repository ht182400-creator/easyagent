...
| **P1** | **合并 Web ↔ Desktop 前端代码**，创建 `packages/frontend` 共享包 ✅ 已完成   | 当文件数突破 200 时，每次新增功能需在两套代码中实现。维护成本将在 4-6 个月内超过功能价值新增             |
...
| 优先级 | 建议                            |   状态    | 备注                                                |
| :----: | ------------------------------- | :-------: | --------------------------------------------------- | ----------------------------- |
| **P1** | **合并 Web ↔ Desktop 前端代码** | ✅ 已完成 | `packages/frontend` 共享包已创建，Desktop+Web 共用 React 组件 |
